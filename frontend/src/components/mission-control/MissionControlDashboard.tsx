...
const INITIAL_ASTRONAUTS: Astronaut[] = [
  {
    id: "AST-001",
    name: "Maya Chen",
    assignedDoctorId: "MED-001",
    assignedMissionId: "M-001",
    online: true,
    status: "On-Duty",
  },
  {
...
const INITIAL_DOCTORS: Doctor[] = [
  { id: "MED-001", name: "Dr. Sarah Wilson", specialty: "Cardiology", onDuty: true, facility: "Ares Medical Bay", shift: "Day", yearsExperience: 14 },
  { id: "MED-002", name: "Dr. Alex Carter", specialty: "Trauma Medicine", onDuty: true, facility: "Ares Medical Bay", shift: "Rotational", yearsExperience: 11 },
  { id: "MED-003", name: "Dr. Emily Tanaka", specialty: "Space Nutrition", onDuty: false, facility: "Bio-Lab Ward", shift: "Night", yearsExperience: 9 },
];
...
const INITIAL_ALERTS: Alert[] = [
  {
    ...
    astronautId: "AST-003",
    severity: "CRITICAL",
    message: "Elevated Muscle Fatigue",
    timestamp: "6m ago",
    assignedDoctorId: "MED-002",
    assignedDoctorName: "Dr. Alex Carter",
  },
  {
    id: "ALT-102",
    astronautId: "AST-002",
    severity: "WARNING",
    message: "Post-EVA Core Temperature Elevation",
    timestamp: "28m ago",
    assignedDoctorId: null,
  ...
  },
  {
    ...
    astronautId: "AST-001",
    severity: "WARNING",
    message: "SpO₂ Drift Below Nominal Range",
    timestamp: "1h ago",
    assignedDoctorId: "MED-001",
  ...
  },
  {
    ...
    astronautId: "AST-004",
    severity: "CRITICAL",
    message: "Renal Stress · Urinary Stone Risk Elevated",
    timestamp: "2h ago",
    assignedDoctorId: "MED-001",
    assignedDoctorName: "Dr. Sarah Wilson",
  },
  {
    ...
    astronautId: "AST-006",
    severity: "WARNING",
    message: "Oxygenation Drift · Venous PO₂",
    timestamp: "3h ago",
    assignedDoctorId: "MED-002",
    assignedDoctorName: "Dr. Alex Carter",
  },
